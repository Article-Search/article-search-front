...
for (let i = 0; i < 30; i++) {
    const article: Article = {
        ...
        institutions: [{name: `Institution ${i}`}, {name: `Institution ${i + 1}`}, {name: `Institution ${i + 2}`}],
        ...
        references: [`http://example.com/reference-${i} http://example.com/reference-${i} http://example.com/reference-${i}`, `http://example.com/reference-${i + 1}`, `http://example.com/reference-${i + 2}`],
    };
